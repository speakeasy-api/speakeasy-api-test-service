...
func main() {
	...
	r.HandleFunc("/errors/responseBody", errors.HandleErrorResponseBody).Methods(http.MethodPost)
	r.HandleFunc("/errors/{status_code}", errors.HandleErrorStatusCode).Methods(http.MethodGet)
