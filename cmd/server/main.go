...
func main() {
	...
	r.HandleFunc("/errors/unionErrors", errors.HandleUnionOfErrors).Methods(http.MethodGet)
	r.HandleFunc("/errors/unionErrorsDiscriminated", errors.HandleDiscriminatedUnionOfErrors).Methods(http.MethodGet)
